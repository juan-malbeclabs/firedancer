...
#define FD_METRICS_GAUGE_TILE_LAST_CPU_OFF  (8UL)
#define FD_METRICS_GAUGE_TILE_LAST_CPU_NAME "tile_last_cpu"
#define FD_METRICS_GAUGE_TILE_LAST_CPU_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_TILE_LAST_CPU_DESC "The CPU that the tile last ran on, as reported by /proc/self/stat."
#define FD_METRICS_GAUGE_TILE_LAST_CPU_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_TILE_PAGE_FAULT_MINOR_COUNT_OFF  (9UL)
...
#define FD_METRICS_COUNTER_TILE_PAGE_FAULT_MINOR_COUNT_DESC "The number of minor page faults serviced by the tile, as reported by /proc/self/stat."
#define FD_METRICS_COUNTER_TILE_PAGE_FAULT_MINOR_COUNT_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_TILE_PAGE_FAULT_MAJOR_COUNT_OFF  (10UL)
...
#define FD_METRICS_COUNTER_TILE_PAGE_FAULT_MAJOR_COUNT_DESC "The number of major page faults serviced by the tile, as reported by /proc/self/stat."
...
#define FD_METRICS_ALL_TOTAL (19UL)
...
#define FD_METRICS_TOTAL_SZ (8UL*413UL)
